...
if(isset($_POST['submit'])){
    ...
    if (!$firstname){
        $_SESSION['add-user'] = 'please enter you firstname';
    }elseif (!$lastname){
        ...
        $_SESSION['add-user'] = 'please add avater';
    } else{
        ...
        if($createpassword !== $confirmpassword){
            ...
            if(mysqli_num_rows($user_check_result) > 0){
                ...
                if(in_array($extention , $allowed_files)){
                    ...
                    $_SESSION['add-user'] = 'Files should be png , jpg , jpeg';
    ...
    if (isset($_SESSION['add-user'])) {
        ...
        $insert_user_query = " INSERT INTO users SET firstname='$firstname', lastname='$lastname', username='$username', email='$email', password='$hash_password', avatar= '$avatar_name', is_admin=$is_admin";
        ...
        if(!mysqli_errno($connection)){
            ...
            $_SESSION['add-user-success'] = "New user $firstname $lastname added succesful.";
